...
const ReviewNavCarts = ({ cinfo }) => {
    const { id, img, name, reviewed_at, review_rating, review_title, review_country } = cinfo;
            ...
            <Link to={`/`}>
                <div className='gap-4 flex justify-between items-center'>
                    ...
                    <div className=' flex flex-col justify-end'>
                        ...
                        <span className='text-gray-600 text-xs'>{review_country}</span>
                    </div>
                </div>
            </Link>
        </div>
